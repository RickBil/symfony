 ...
 */
final class Version20221024011413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_gab (id INT AUTO_INCREMENT NOT NULL, date_exp VARCHAR(12) NOT NULL, numero VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
